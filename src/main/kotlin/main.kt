...
fun main() = application {
    Window(
        ...
        val loader =
            CustomLevelsLoader("D:\\Games\\SteamLibrary\\steamapps\\common\\Beat Saber\\Beat Saber_Data\\CustomLevels")
                    ...
                    Column {
                        loader.getSongData().map { song ->
                            Row(
                                ...
                                Column {
                                    Image(
                                        bitmap = org.jetbrains.skia.Image.makeFromEncoded(File(song.path + File.separator + song.coverImage).readBytes())
                                            .asImageBitmap(),
